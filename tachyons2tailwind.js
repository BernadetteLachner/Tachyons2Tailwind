...
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(outline)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "outline"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(top-0)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "top-0"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(right-0)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "right-0"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(bottom-0)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "bottom-0"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(left-0)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "left-0"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(flex)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "flex"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(inline-flex)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "inline-flex"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(flex-auto)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "flex-auto"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(flex-none)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "flex-none"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(flex-column)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "flex-column"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(flex-row)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "flex-row"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(flex-wrap)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "flex-wrap"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(flex-nowrap)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "flex-nowrap"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(flex-wrap-reverse)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "flex-wrap-reverse"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(flex-column-reverse)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "flex-column-reverse"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(flex-row-reverse)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "flex-row-reverse"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(items-start)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "items-start"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(items-end)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "items-end"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(items-center)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "items-center"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(items-baseline)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "items-baseline"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(items-stretch)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "items-stretch"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(self-start)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "self-start"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(self-end)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "self-end"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(self-center)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "self-center"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(self-baseline)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "self-baseline"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(self-stretch)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "self-stretch"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(justify-start)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "justify-start"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(justify-end)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "justify-end"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(justify-center)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "justify-center"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(justify-between)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "justify-between"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(justify-around)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "justify-around"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(content-start)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "content-start"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(content-end)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "content-end"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(content-center)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "content-center"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(content-between)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "content-between"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(content-around)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "content-around"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(content-stretch)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "content-stretch"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(order-1)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "order-1"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(order-2)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "order-2"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(order-3)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "order-3"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(order-4)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "order-4"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(order-5)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "order-5"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(order-6)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "order-6"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(order-7)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "order-7"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(order-8)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "order-8"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(order-last)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "order-last"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(flex-grow-0)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "flex-grow-0"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(flex-grow-1)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "flex-grow-1"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(flex-shrink-0)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "flex-shrink-0"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(flex-shrink-1)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "flex-shrink-1"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(overflow-visible)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "overflow-visible"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(overflow-hidden)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "overflow-hidden"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(overflow-scroll)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "overflow-scroll"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(overflow-auto)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "overflow-auto"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(overflow-x-visible)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "overflow-x-visible"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(overflow-x-hidden)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "overflow-x-hidden"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(overflow-x-scroll)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "overflow-x-scroll"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(overflow-x-auto)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "overflow-x-auto"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(overflow-y-visible)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "overflow-y-visible"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(overflow-y-hidden)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, ""],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(overflow-y-scroll)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "overflow-y-hidden"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(overflow-y-auto)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "overflow-y-auto"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(static)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "static"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(relative)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "relative"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(absolute)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "absolute"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(fixed)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "fixed"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(underline)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "underline"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(no-underline)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "no-underline"],
[/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(truncate)\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "truncate"],
//all padding and margins:  [/class=.*?\s?(?:\s|\"|\'|hover\-)(\b(((p|m)(a|l|t|b|r|v|h))([0-7]))\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "padmar"],
//all colors, border-colors & background colors: [/class=.*?\s?(?:\s|\"|\'|hover\-)(|bg-|b--)(\b((color))\b)(?:\s|\"|\'|-l|-m|-ns).*?\s?\>/g, "color"],
			];
			...
			fs.writeFile(secretFBIfile, result, 'utf8', function (err) {
				if (err) return console.log(err);
					...
					console.log("..." + file + " has been switched")
				};
			});
		});
	});
